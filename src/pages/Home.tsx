...
export default function Home() {
  return (
    <div className="bg-white text-gray-800 min-h-screen">
      <div className="flex">
        ...
        <main className="p-8 max-w-8xl mx-auto space-y-12">
          <section id="welcome" className="space-y-4">
            ...
            <p className="text-lg">
              Easily compare how different Large Language Models (LLMs) perform
              on structured entity extraction tasks — while also boosting
          ...
          <section id="how-to-use">
            <section className="mt-12">
              ...
              <p>
                Upload a CSV file containing text records. After uploading,
                you'll be able to select which columns are used for entity
                extraction.
              </p>
            </section>
            <section className="mt-12">
                        ...
                        <tr className="align-top">
                          ...
                          <td className="border px-4 py-2">
                            ...
                            <ul className="list-disc list-inside mt-2 space-y-1">
                              <li>
                                Use standard terms (e.g., Bacteria, Fungi)
                              </li>
                              <li>
                                <strong>Other</strong> for unlisted soil
                                organisms
                              </li>
                              <li>
                              ...
                              <li>
                                <strong>Wrong_P</strong> for non-soil taxa
                                (e.g., crops)
                              </li>
                            </ul>
                          </td>
                  ...
                  <table className="w-full table-auto border text-sm bg-white">
                    ...
                    <tbody>
                      <tr className="align-top">
                        ...
                        <td className="border px-4 py-2">
                          All things in or near soil maybe. Could include
            ...
            <section className="mt-12">
              ...
              <p>
                Choose up to three LLMs to perform entity and evidence
                extraction. You can compare their performance side-by-side.
              </p>
            </section>
            ...
            <section className="mt-12">
              ...
              <p className="mt-2">
                Each result has a <strong>Final Entity</strong> field,
                initialized as the deduplicated union of all models' outputs.
                You can manually edit this field to define the gold-standard
            ...
            <section className="mt-12">
              ...
              <div className="mt-4 space-y-2 text-sm">
                ...
                <p>
                  <strong>⚠️ False Negative (FN):</strong> Entities present in
                  the final list but missed by the model.
                </p>
              </div>
              ...
              <p className="mt-4">
                ...
                entity type across all records. You can find the full breakdown
                in the “LLM Evaluation Summary” section after running an
                analysis.
              </p>
            </section>
          </section>
          <section id="usecases" className="mt-12">
            ...
            <p className="mt-2">
              Perfect for NLP researchers, data scientists, and product teams
              who want to evaluate LLM performance on real-world extraction
              tasks like:
            </p>
          ...
          <section id="billing" className="mt-12">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700">
              ...
              <li>
                <strong>Paid LLMs</strong> will deduct credits from your
                balance. The cost is calculated as{" "}
            ...
            <p className="mt-4 text-sm text-gray-600 italic">
              Claude Sonnet and GPT-4 offer premium results with moderate to
              high cost. GPT-4.1 Nano is ultra low-cost, and Mistral Small is
              entirely free. Choose models based on your balance, budget, and
              accuracy needs.
            </p>
          </section>
      ...
      <footer className="w-full  mt-16 text-center text-gray-400 text-sm p-4 border-t">
